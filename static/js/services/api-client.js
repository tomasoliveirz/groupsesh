...
(function() {
    ...
    // Expõe no escopo global o objeto APIClient
    window.APIClient = {
      /**
       ...
       * @param {Object} surveyData - Dados da survey (title, description, etc.)
       ...
       * (endpoint /api/join-survey/:token).
    ...
    // Opcionalmente, se você quiser compatibilidade com window.API:
    if (!window.API) {
